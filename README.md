...
I spent a week looking at the BTC chart inorder to isolate the factors that affect BTC price, and realised there's one particular line of logic that achieved around 65% win rate.
